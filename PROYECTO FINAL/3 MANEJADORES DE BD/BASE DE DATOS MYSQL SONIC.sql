...
CREATE TABLE Acto
(
idActo INT NOT NULL AUTO_INCREMENT,
...
(
idBandaSonora INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(40)NOT NULL,
tipo VARCHAR(10)NOT NULL,
descripcion VARCHAR(10) NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idBandaSonora)
);
CREATE TABLE BandaSonoraZona
(
idBandaSonoraZona INT NOT NULL AUTO_INCREMENT,
idBandaSonora INT NOT NULL,
idZona INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idBandaSonoraZona)
);
CREATE TABLE Bucle
(
idBucle INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(20)NOT NULL,
...
(
idCajaDeObjeto INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(20)NOT NULL,
tipo VARCHAR(20)NOT NULL,
descripcion VARCHAR(30)NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
idZona int not null,
PRIMARY KEY (idCajaDeObjeto)
);
...
CREATE TABLE Comic
(
idComic INT NOT NULL AUTO_INCREMENT,
...
(
idConfiguracionJugador INT NOT NULL AUTO_INCREMENT,
idConfiguracion INT NOT NULL,
idJugador INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idConfiguracionJugador)
);
CREATE TABLE Contrareloj
(
idContrareloj INT NOT NULL AUTO_INCREMENT,
limite VARCHAR(20) NOT NULL,
nombre VARCHAR(30)NOT NULL,
descripcion VARCHAR(50)NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idContrareloj)
);
...
(
idDispositivoDeEntrada INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(20)NOT NULL,
modelo VARCHAR(10)NOT NULL,
descripcion VARCHAR(40)NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
idJugador int not null,
PRIMARY KEY (idDispositivoDeEntrada)
);
...
CREATE TABLE Era
(
idEra INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE Escena
(
idEscena INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(50)NOT NULL,
descripcion VARCHAR(50) NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idEscena)
);
...
(
idEscenaZona INT NOT NULL AUTO_INCREMENT,
idEscena INT NOT NULL,
idZona INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idEscenaZona)
);
CREATE TABLE Escudo
(
idEscudo INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(20)NOT NULL,
tipo VARCHAR(20)NOT NULL,
...
estatus BIT DEFAULT 1 NOT NULL,
idPersonaje int not null,
PRIMARY KEY (idEscudo)
);
CREATE TABLE Esmeralda
(
idEsmeralda INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(30)NOT NULL,
color VARCHAR(20)NOT NULL,
tipo VARCHAR(20)NOT NULL,
descripcion VARCHAR(50) NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idEsmeralda)
);
CREATE TABLE EsmeraldaZona
(
idEsmeraldaZona INT NOT NULL AUTO_INCREMENT,
idEsmeralda INT NOT NULL,
idZona INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idEsmeraldaZona)
);
CREATE TABLE EstiloVisual
(
idEstiloVisual INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(10)NOT NULL,
detalles VARCHAR(30)NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
idMundo int not null,
PRIMARY KEY (idEstiloVisual)
);
CREATE TABLE Extra
(
...
(
idFinalZona INT NOT NULL AUTO_INCREMENT,
idFinal INT NOT NULL,
idZona INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idFinalZona)
);	
CREATE TABLE GameCenter
(
idGameCenter INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(50)NOT NULL,
logro VARCHAR(50)NOT NULL,
descripcion VARCHAR(50) NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
idJugador int not null,
PRIMARY KEY (idGameCenter)
);
CREATE TABLE Gema
(
idGema INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(30)NOT NULL,
color VARCHAR(20)NOT NULL,
tipo VARCHAR(20)NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
...
(
idGemaZona INT NOT NULL AUTO_INCREMENT,
idGema INT NOT NULL,
idZona INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idGemaZona)
);
...
(
idJefeZona INT NOT NULL AUTO_INCREMENT,
idJefe INT NOT NULL,
idZona INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idJefeZona)
);	
...
(
idMercanciaPersonaje INT NOT NULL AUTO_INCREMENT,
idMercancia INT NOT NULL,
idPersonaje INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idMercanciaPersonaje)
);
CREATE TABLE Minijuego
(
idMinijuego INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(20)NOT NULL,
...
(
idModoDeJuego INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(10)NOT NULL,
descripcion VARCHAR(50)NOT NULL,
...
estatus BIT DEFAULT 1 NOT NULL,
idJugador int not null,
PRIMARY KEY (idModoDeJuego)
);
CREATE TABLE ModoDeJuegoJugador
(
idModoDeJuegoJugador INT NOT NULL AUTO_INCREMENT,
idModoDeJuego INT NOT NULL,
idJugador INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idModoDeJuegoJugador)
);	
CREATE TABLE Mundo
(
...
(
idPortalMundo INT NOT NULL AUTO_INCREMENT,
idPortal INT NOT NULL,
idMundo INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idPortalMundo)
);
CREATE TABLE PuntoDeControl
(
idPuntoDeControl INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(50)NOT NULL,
guardado VARCHAR(50) NOT NULL,
descripcion VARCHAR(50)NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
idZona int not null,
PRIMARY KEY (idPuntoDeControl)
);
CREATE TABLE PuntoDeControlZona
(
idPuntoDeControlZona INT NOT NULL AUTO_INCREMENT,
idPuntoDeControl INT NOT NULL,
idZona INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idPuntoDeControlZona)
);	
CREATE TABLE Ring
(
...
(
idRingZona INT NOT NULL AUTO_INCREMENT,
idRing INT NOT NULL,
idZona INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idRingZona)
);
CREATE TABLE Ruta
(
...
(
idRutaZona INT NOT NULL AUTO_INCREMENT,
idRuta INT NOT NULL,
idZona INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idRutaZona)
);		
CREATE TABLE Saga
(
...
(
idSagaJugador INT NOT NULL AUTO_INCREMENT,
idSaga INT NOT NULL,
idJugador INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idSagaJugador)
);
CREATE TABLE Serie
(
...
(
idSerieSaga INT NOT NULL AUTO_INCREMENT,
idSerie INT NOT NULL,
idSaga INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idSerieSaga)
);		
CREATE TABLE Team
(
...
(
idTeamPersonaje INT NOT NULL AUTO_INCREMENT,
idTeam INT NOT NULL,
idPersonaje INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idTeamPersonaje)
);
CREATE TABLE Tiempo
(
...
CREATE TABLE Vida
(
idVida INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(20)NOT NULL,
cantidad INT NOT NULL,
descripcion VARCHAR(20)NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
...
(
idVidaPersonaje INT NOT NULL AUTO_INCREMENT,
idVida INT NOT NULL,
idPersonaje INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idVidaPersonaje)
);		
CREATE TABLE Zona
(
...
(
idZonaEspecial INT NOT NULL AUTO_INCREMENT,
nombre VARCHAR(30)NOT NULL,
tipo VARCHAR(20)NOT NULL,
nivel INT NOT NULL,
descripcion VARCHAR(50)NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
idMundo int not null,
PRIMARY KEY (idZonaEspecial)
);
CREATE TABLE ZonaEspecialMundo
(
idZonaEspecialMundo INT NOT NULL AUTO_INCREMENT,
idZonaEspecial INT NOT NULL,
idMundo INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idZonaEspecialMundo)
);	
CREATE TABLE ZonaMundo
(
idZonaMundo INT NOT NULL AUTO_INCREMENT,
idZona INT NOT NULL,
idMundo INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
PRIMARY KEY (idZonaMundo)
);
